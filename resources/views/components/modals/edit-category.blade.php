    ...
    >
        ...
        <form id="edit-category-form" method="POST">
            ...
            <div class="px-6 py-5 space-y-4">
                ...
                {{-- Nama Kategori --}}
                <div>
                    <label for="edit_name" class="text-sm font-semibold text-gray-700">Nama Kategori</label>
                    <input 
                        type="text" 
                        name="name" 
                        id="edit_name"
                ...
                {{-- Deskripsi --}}
                <div>
                    <label for="edit_description" class="text-sm font-semibold text-gray-700">Deskripsi (Opsional)</label>
                    <textarea 
                        name="description" 
                        id="edit_description" 
                        rows="3"
